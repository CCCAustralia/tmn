...
class PersonalDetails {
	...
	/**
	 * The constructor method for PersonalDetails.
	 * Parameters set the object's guid and debug global variables.
	 * Also sets up the database connection object.
	 * @param string $guid
	 * The user's GCX guid.
	 * @param bit $dbug
