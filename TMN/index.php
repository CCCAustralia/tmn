					...
					<html>
						...
						<body>
							...
							<form class="body-look" name="security_scan" action="security_scan.php?ticket=' . $_REQUEST['ticket'] . '" method="post">
								...
								<label for="email">GCX Email Address: </label>
								<input type="text" name="email" value="' . $tmn->getEmail() . '" style="position:relative;left:70px;" readonly /><br />
								<span>(this is how we will contact you, if it is wrong go to <a href="https://signin.mygcx.org/cas/selfservice.htm">https://signin.mygcx.org/cas/selfservice.htm</a> and update it. Then try to register again.)</span><br /><br />
