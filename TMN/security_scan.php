...
mail("tech.team@ccca.org.au","TMN REGISTRATION", "Guid: ".($xmlobject->authenticationSuccess->attributes->ssoGuid)."\nFirst Name: ".$_POST['firstname']."\nLast Name: ".$_POST['lastname']."\nFinancial Account Number: ".$_POST['fan']."\nEmail: ".($xmlobject->authenticationSuccess->user), "From: TMN");
